...
class PlaceOrderBody {
  ...
  PlaceOrderBody({
    ...
    this._customerLat = customerLat;
    this._customerLng = customerLng;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['customer_lat'] = this._customerLat;
    data['customer_lng'] = this._customerLng;
    return data;
  }
}
