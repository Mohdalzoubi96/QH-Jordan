...
import 'package:flutter_grocery/view/screens/main_category/main_category_screen.dart';
...
class RouteHelper {
  ...
  static String mainCat = '/main-cat';
  ...
  static String getMainCatRoute() => mainCat;
  ...
  static String getCategoryProductsRouteNew(
      {CategoryModel categoryModel, String subCategory}) {
    String _data =
  ...
  static String getProfileEditRoute(UserInfoModel userInfoModel) {
    String _data =
        base64Url.encode(utf8.encode(jsonEncode(userInfoModel.toJson())));
  ...
  static Handler _loginHandler = Handler(
      handlerFunc: (BuildContext context, Map<String, dynamic> params) =>
          LoginScreen());
  static Handler _mainCatHandler = Handler(
      handlerFunc: (BuildContext context, Map<String, dynamic> params) =>
          MainCatScreen());
  ...
  static Handler _updateAddressHandler =
    ...
    return _addNewAddressScreen != null
        ...
        : AddNewAddressScreen(
            isEnableUpdate: true,
            fromCheckout: false,
            address: AddressModel.fromJson(jsonDecode(_decoded)),
          );
  });
...
/*  static Handler _orderSuccessfulHandler = Handler(handlerFunc: (BuildContext context, Map<String, dynamic> params) {
  ...
  static Handler _profileEditHandler =
    ...
    return ProfileEditScreen(
        userInfoModel: UserInfoModel.fromJson(jsonDecode(_decoded)));
  });
  ...
  static Handler _faqHandler = Handler(
      handlerFunc: (context, Map<String, dynamic> params) =>
          HtmlViewerScreen(htmlType: HtmlType.FAQ));
  ...
  static void setupRouter() {
    ...
    router.define(mainCat,
        handler: _mainCatHandler, transitionType: TransitionType.fadeIn);
