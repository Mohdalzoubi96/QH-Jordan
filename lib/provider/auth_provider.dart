...
class AuthProvider with ChangeNotifier {
  ...
  Future<ResponseModel> login(
    ...
    if (apiResponse.response != null &&
      ...
      int catId = int.parse(map["cat_id"]);
      sharedPreferences.setInt(AppConstants.CATEGORY_ID, catId);
      final selectedCatId =
          sharedPreferences.getInt(AppConstants.SELECTED_CATEGORY_ID);
      ...
      if (catId == selectedCatId) {
        ...
        _loginErrorMessage = getTranslated('wrong_selected_category', context);
