...
import '../main_category/main_category_screen.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<bool> _willPopCallback() async {
    Navigator.of(context)
        .pushReplacementNamed(RouteHelper.mainCat, arguments: MainCatScreen());
    return true;
  }
  ...
  Widget build(BuildContext context) {
    ...
    final _socialStatus = Provider.of<SplashProvider>(context, listen: false)
        .configModel
        .socialLoginStatus;
