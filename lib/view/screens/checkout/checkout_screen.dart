        ...
        onPressed: () {
          if (!_selfPickup && order.addressIndex == -1) {
            ...
            for (int index = 0; index < _cartList.length; index++) {
              debugPrint('test now ? ${_cartList[index].itemDesc}');
              Cart cart = Cart(
                ...
                comment: _cartList[index].itemDesc,
              );
              carts.add(cart);
            }
            ...
            PlaceOrderBody _placeOrderBody = PlaceOrderBody(
              ...
              customerLat: _currentPosition.latitude.toString(),
              customerLng: _currentPosition.longitude.toString(),
            );
            ...
            if (_isCashOnDeliveryActive &&
              ...
              if (_fullNameController.text.isEmpty) {
                showCustomSnackBar(
                    getTranslated('your_name_required', context), context);
              } else if (_phoneNumberController.text.isEmpty) {
                showCustomSnackBar(
                    getTranslated('your_phone_required', context), context);
              } else if (_addressController.text.isEmpty) {
                showCustomSnackBar(
                    getTranslated('your_address_required', context), context);
              } else {
