...
class MenuWidget extends StatelessWidget {
                        ...
                        child: Consumer<SplashProvider>(
                          builder: (context, splash, child) {
                            return Column(children: [
                              ...
                              //   title: getTranslated('whats_app', context),
                              // ),
                              ListTile(
                                onTap: () {
                                  whatsapp(context);
                                ...
                                title: Text(
                                  getTranslated('whats_app', context),
  ...
  void whatsapp(BuildContext context) async {
    var contact = "+962797456406";
    var androidUrl = "whatsapp://send?phone=$contact&text=Hi";
    var iosUrl =
        "https://wa.me/$contact?text=${Uri.parse('Hi, I need some help')}";
    var webUri = 'https://api.whatsapp.com/send?phone=+962797456406&text=hii';
